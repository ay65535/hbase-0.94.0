...
# JDK1.5以降はこう指定する。 ( http://www.ne.jp/asahi/hishidama/home/tech/eclipse/debug.html#remote_debug )
#export HBASE_MASTER_OPTS="$HBASE_MASTER_OPTS -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=8070"
#export HBASE_REGIONSERVER_OPTS="$HBASE_REGIONSERVER_OPTS -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=8071"
#export HBASE_THRIFT_OPTS="$HBASE_THRIFT_OPTS -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=8072"
#export HBASE_ZOOKEEPER_OPTS="$HBASE_ZOOKEEPER_OPTS -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=8073"
